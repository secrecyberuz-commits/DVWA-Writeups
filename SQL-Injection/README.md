...
Natijada SQL buyruqlari yordamida birnechta malumotlar qaytarildi.

Security level: Medium

Mediumda SQL Injection xavfini kamaytirish uchun foydalanuvchi malumotini POST orqali qabul qiladi hamda mysql_real_escape_string() funksiyasidan foydalanadi. Biroq foydalanuvchi qiymati hali ham SQL so'roviga qo'shiladi.
Source code:

![DVWA SQL Injection](./images/04-dvwa.png)

mysql_real_escape_string() funksiyasi qo'shilgan bo'lsada, foydalanuvchi kiritgan qiymat sql so'roviga to'g'ridan to'g'ri qo'shildi.
...
Lekin foydalanuvchi yuborgan sql so'rovi hech qandat tekshiruvlarsiz qo'shilganligi sababli, zaiflik yo'qolmagan.
Source code:
